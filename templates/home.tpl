<div class="row">
	<div widget-area="sidebar" class="col-lg-12 col-sm-12 hidden"></div>
</div>
<div class="row home" itemscope itemtype="http://www.schema.org/ItemList">
	<div class="col-lg-12 col-sm-12" no-widget-class="col-lg-12 col-sm-12">
		<div class="row">
			<!-- BEGIN categories -->
			<div class="col-md-12 col-sm-12 col-xs-12 category-item" data-cid="{categories.cid}" data-numRecentReplies="{categories.numRecentReplies}">
				...
				<div class="category-icon row">
					...
					<div class="category-box col-md-10">
						<!-- IF categories.link -->
